...
public class TransactionStateLuceneIndexWriter implements LuceneIndexWriter, Closeable
{
    ...
    FulltextIndexReader getNearRealTimeReader() throws IOException
    {
        ...
        return new SimpleFulltextIndexReader( searcherRef, index.getPropertiesArray(), index.getAnalyzer(), index.getPropertyKeyTokenHolder(), index.getSortPropertiesArray(), index.getSortTypes() );
    }
